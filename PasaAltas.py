...
cutoff_freq = 5000  # Frecuencia de corte en Hz
order = 5  # Orden del filtro

# Función para diseñar y aplicar el filtro pasa altas
...
while True:
    ...
    filtered_data = butter_highpass_filter(dataInt, cutoff_freq, Fs, order)
